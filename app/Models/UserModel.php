...
class UserModel extends Model
{
    ...
    protected $allowedFields = ['username', 'fullname', 'balance', 'level', 'status', 'uplink', 'password','user_ip'];
    ...
    public function API_getUser()
    {
        ...
        $builder->select('CONCAT(users.id_users) as id, username, fullname, balance, level, status, uplink');

        return DataTable::of($builder)
            ->setSearchableColumns(['username', 'fullname', 'balance', 'uplink'])
