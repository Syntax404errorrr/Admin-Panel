            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-2">
                        ...
                        <input type="number" name="balance" id="balance" class="form-control" placeholder="" aria-describedby="help-balance" value="<?= old('balance') ?: $target->balance ?>">
                        <?php if ($validation->hasError('balance')) : ?>
                            <small id="help-balance" class="form-text text-danger"><?= $validation->getError('balance') ?></small>
                        <?php endif; ?>
                    </div>
                    <div class="col-md-6 mb-2">
