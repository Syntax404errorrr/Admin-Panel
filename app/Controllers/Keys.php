...
class Keys extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $this->game_list = [
            ...
            'BLOODSTRIKE' => 'BLOODSTRIKE FPS'
            'CROSSFIRE' => 'CROSS FIRE LEGENDS'
        ];

        $this->duration = [
            1 => '1 Days &mdash; $5/Device',
            3 => '3 Days &mdash; $10/Device',
            7 => '7 Days &mdash; $15/Device',
            14 => '14 Days &mdash; $25/Device',
            30 => '30 Days &mdash; $30/Device',
        ];
